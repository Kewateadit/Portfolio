      ...
      <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a href="#resume" className="group flex items-center gap-2 bg-white text-text-primary border border-gray-200 px-6 py-3 rounded-full font-medium transition-all hover:border-gray-300 hover:bg-gray-50">
